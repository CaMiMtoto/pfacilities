...
<head>
    ...
    <title>License Letter for {{ $license->userApplication->facility->name }} </title>
    ...
    <div class="container mt-3">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12" style="border: 1px solid">
                ...
                <div class="mt-3 mb-3">
                    <p>
                        The holder of this certifcate commits to abide by the rules and regulations for private health
                        practice in Rwanda.
                    </p>
                </div>
                <div class="mt-5 mb-3">
